#!/usr/bin/env python3
"""Basic usage example for pyprojecttest.

This example demonstrates the most common usage patterns for the package.
"""

from pyprojecttest import __version__, get_logger, greet, setup_logging


def main() -> None:
    """Run basic usage examples."""
    # Display package version
    print(f"Using pyprojecttest version {__version__}")
    print()
