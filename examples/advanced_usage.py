#!/usr/bin/env python3
"""Advanced usage example for pyprojecttest.
...
from pyprojecttest import __version__, get_logger, setup_logging
...
def main() -> None:
    ...
    print(f"Advanced Examples - pyprojecttest v{__version__}")
    print("=" * 60)
    print()
